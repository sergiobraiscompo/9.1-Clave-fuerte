...
describe('validarClave', () => {    
    it.each([
        ...
        [ "otheruser", "Otheruser_123", {esValida: false, error: "La clave no debe contener el nombre del usuario."} ],
        [ "otheruser", "Password123.", {esValida: false, error: "Evita usar palabras o combinaciones de números comunes."} ],
